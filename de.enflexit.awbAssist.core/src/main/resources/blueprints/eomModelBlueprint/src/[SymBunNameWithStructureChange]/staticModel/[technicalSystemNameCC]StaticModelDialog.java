...
public class [technicalSystemNameCC]StaticModelDialog extends AbstractStaticModelDialog implements ActionListener {

	private static final long serialVersionUID = 4944933489538553875L;
	
	private [technicalSystemNameCC]StaticDataModel staticDataModel;
	...
	/**
	 * Instantiates a new [technicalSystemName] static model dialog.
	 *
	 * @param owner the owner
	 * @param staticModel the static model
	 */
	public [technicalSystemNameCC]StaticModelDialog(Window owner, AbstractStaticModel staticModel) {
		super(owner, staticModel);
		this.setStaticDataModel(([technicalSystemNameCC]StaticDataModel) staticModel.getStaticDataModel());
		initialize();
	}
	...
	private void initialize() {
		this.setTitle("[technicalSystemName] Static Data Model");
	 ...
	 */
	public [technicalSystemNameCC]StaticDataModel getStaticDataModel() {
		if (staticModel.getStaticDataModel() == null){
			staticDataModel = new [technicalSystemNameCC]StaticDataModel();
	 ...
	 *
	 * @param staticDataModel the [technicalSystemName]DataModel to set
	 */
	public void setStaticDataModel([technicalSystemNameCC]StaticDataModel staticDataModel) {
	...
	private void setErrorMessage(String message) {
		[technicalSystemNameCC]StaticModelDialog.this.getJLabelErrorMessage().setText(message);
	}
