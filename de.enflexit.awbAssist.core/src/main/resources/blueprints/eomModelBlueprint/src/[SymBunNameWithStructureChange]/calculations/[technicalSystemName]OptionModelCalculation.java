...
public class [technicalSystemName]OptionModelCalculation extends AbstractOptionModelCalculation {

	public [technicalSystemName]OptionModelCalculation(OptionModelController optionModelController) {
