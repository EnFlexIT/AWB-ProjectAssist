...
public class [technicalSystemName]StaticModelDialog extends AbstractStaticModelDialog implements ActionListener {

	private static final long serialVersionUID = 4944933489538553875L;
	
	private [technicalSystemName]StaticDataModel staticDataModel;
	 ...
	 */
	public [technicalSystemName]StaticModelDialog(Window owner, AbstractStaticModel staticModel) {
		super(owner, staticModel);
		this.setStaticDataModel(([technicalSystemName]StaticDataModel) staticModel.getStaticDataModel());
		initialize();
	}
	 ...
	 */
	public [technicalSystemName]StaticDataModel getStaticDataModel() {
		if (staticModel.getStaticDataModel() == null){
			staticDataModel = new [technicalSystemName]StaticDataModel();
	 ...
	 */
	public void setStaticDataModel([technicalSystemName]StaticDataModel staticDataModel) {
