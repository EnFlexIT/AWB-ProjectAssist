...
import [SymBundleName].gen.InfoApi;
import [SymBundleName].gen.InfoApiService;
import [SymBundleName].gen.NotFoundException;
import [SymBundleName].gen.model.NetworkConnection;
...
public class InfoApiImpl extends InfoApiService {
	...
	/* (non-Javadoc)
	 * @see [SymBundleName].gen.InfoApiService#infoGet(javax.ws.rs.core.SecurityContext)
	 */
	@Override
