...
public class [technical system name]StaticModelDialog extends AbstractStaticModelDialog implements ActionListener {

	private static final long serialVersionUID = 4944933489538553875L;
	
	private [technical system name]StaticDataModel staticDataModel;
	...
	/**
	 * Instantiates a new [technical system name] static model dialog.
	 *
	 * @param owner the owner
	 * @param staticModel the static model
	 */
	public [technical system name]StaticModelDialog(Window owner, AbstractStaticModel staticModel) {
		super(owner, staticModel);
		this.setStaticDataModel(([technical system name]StaticDataModel) staticModel.getStaticDataModel());
		initialize();
	}
	...
	private void initialize() {
		this.setTitle("[technical system name] Static Data Model");
	 ...
	 */
	public [technical system name]StaticDataModel getStaticDataModel() {
		if (staticModel.getStaticDataModel() == null){
			staticDataModel = new [technical system name]StaticDataModel();
	 ...
	 *
	 * @param staticDataModel the [technical system name]DataModel to set
	 */
	public void setStaticDataModel([technical system name]StaticDataModel staticDataModel) {
	...
	private void loadDataModelToDialog(){
		...
		private void setErrorMessage(String message) {
			[technical system name]StaticModelDialog.this.getJLabelErrorMessage().setText(message);
		}
